...
local games = {
    ...
    {GameId = 2788229376, X_CHANGE = 0.49, Y_CHANGE = 0.89, MOUSE_OFFSET = Vector2.new(0, 0)} --Bad Buisness
}
...
top.Title.Text = "Nigga Balls v"..version
    ...
    RunService.RenderStepped:Connect(function() --Fires every frame, handles precice aiming
        ...
        if _settings.enabled and not stopped then
            ...
            elseif isHovering(buttons.AimPart) then
                ...
                t("Make sure to set your sensitivity to 0.36 (1 bar) or else the aimbot will freak out! Report any bugs to acid$$#9688 on Discord. Join the discord server: discord.me/temporal")
            end
